...
class AnswerModel{
    ...
    public static function createAnswer($question_id, $account_id, $content, $create_at, $update_at){
        global $conn;
        $sql = "INSERT INTO answer(question_id, account_id, content, create_at, update_at) VALUES (?,?,?,?,?);";
        ...
        $stmt->bind_param("iisss",$question_id, $account_id, $content, $create_at, $update_at);
