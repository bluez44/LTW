    ...
    <form onSubmit={handleLogin} className="d-flex flex-column gap-4 w-100" method="POST">
      <div className="position-relative py-3 px-4 border rounded-3 auth_input text-vng-text">
        ...
        <input
          ...
          name="username"
          id="username"
          className="outline-none border-none w-100 bg-body py-2"
          type="text"
      ...
      <div className="position-relative py-3 px-4 border rounded-3 auth_input text-vng-text">
        ...
        <div className="position-relative py-2">
          <input
            ...
            name="password"
            id="password"
            className="outline-none border-none w-100 bg-body px-5 py-2"
      ...
      <button className="btn btn-vng-third border border-vng-third text-white py-4" type="submit" onClick={(e) => {}}>
        Tiếp tục
      </button>
    </form>
  );
