...
const newsList = ['Tất cả', 'Thông cáo báo chí', 'Tin tức doanh nghiệp', 'Báo cáo'];
    ...
    <div className="">
      ...
      <section id="section2" className="homepage_section2 pt-5 position-relative">
        <div className="position-absolute top-0 start-0 w-100 h-100 z-n1">
          <img
            src="https://corp.vcdn.vn/products/vng/skin-2021/dist/main/images/bg/f2.jpg"
            alt="background"
            width={'100%'}
            height={'100%'}
          />
        ...
        <div className="container px-0">
          ...
          <p className="fs-2 fw-bold text-vng-text-bold mw-100 mw-xl-60">
            Kiến tạo công nghệ và phát triển con người. Từ Việt Nam vươn tầm thế giới.
          </p>
          <div className="row py-5">
            {missions.length &&
              missions.map((mission, index) => (
                <div className="col col-12 col-md-4 my-3" key={index}>
                  <SectionCard
                    title={mission.title}
                    icon={
                      index % 3 == 0 ? (
                        <HiOutlineDocumentSearch size={80} className="text-vng-secondary" />
                      ) : index % 3 == 1 ? (
                        <FaPeopleGroup size={80} className="text-vng-secondary" />
                      ) : (
                        <IoIosTrendingUp size={80} className="text-vng-secondary" />
                      )
                    }
          ...
          <div className="row mb-5">
            <div className="col col-12 col-md-6 col-xl-4 mb-3">
              <SectionNewsCard
                ...
                description={
                  'Bộ môn Thể thao điện tử lần đầu được vinh danh tại chương trình “Vinh quang Thể thao Việt Nam 2025” nhờ các thành tích n ...'
                }
              />
            </div>
            <div className="col col-12 col-md-6 col-xl-4 mb-3">
              <SectionNewsCard
                ...
                description={
                  'Du khách Việt đến Singapore đã có thể sử dụng ứng dụng Zalopay để quét mã QR và thanh toán dễ dàng như người bản địa.  '
                }
              />
            </div>
            <div className="col col-12 col-md-6 col-xl-4 mb-3">
              <SectionNewsCard
                ...
                description={
                  'VNGGames chính thức ra mắt Level Up Launcher - nền tảng tích hợp các tựa game PC, mang đến trải nghiệm game toàn diện ch ...'
                }
              />
            </div>
          </div>
